...
@Component({
  selector: 'app-rundgang-edit-verantwortlicher',
  templateUrl: './rundgang-edit-verantwortlicher.component.html',
  styleUrls: ['./rundgang-edit-verantwortlicher.component.scss']
})
export class RundgangEditVerantwortlicherComponent implements OnInit, OnDestroy {
