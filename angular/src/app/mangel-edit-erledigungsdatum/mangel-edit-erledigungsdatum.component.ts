...
@Component({
  selector: 'app-mangel-edit-erledigungsdatum',
  templateUrl: './mangel-edit-erledigungsdatum.component.html',
  styleUrls: ['./mangel-edit-erledigungsdatum.component.scss']
})
export class MangelEditErledigungsdatumComponent implements OnInit {
