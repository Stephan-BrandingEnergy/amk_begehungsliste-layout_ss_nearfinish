...
@Component({
  selector: 'app-mangel-edit-verantwortliche-person',
  templateUrl: './mangel-edit-verantwortliche-person.component.html',
  styleUrls: ['./mangel-edit-verantwortliche-person.component.scss']
})
export class MangelEditVerantwortlichePersonComponent implements OnInit {
